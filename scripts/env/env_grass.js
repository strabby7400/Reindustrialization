...
*/
  ...
  // Part: Component
    function drawBaseComp(blk, t) {
      mdl_draw.drawBlurredShadow(mdl_game._pos(1, t), blk.region, 0.0, 1.0, 1.05, Color.white, 7.0);
      mdl_draw.drawWobbleRegion(mdl_game._pos(2, t), blk.region, 0.0, 1.0, 1.0, Color.white, 0.65, 2.0, 0.85, 0.6, 8.0);
    };
  // End
