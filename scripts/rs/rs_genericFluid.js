...
*/
  ...
  // Part: Component
    function setStatsComp_genericFluid(liq) {
    ...
    function updateComp_genericFluid(liq, puddle) {
      // Update fix
...
*/
  ...
  // Part: Integration
    const setStats_genericFluid = function(liq) {
      rs_genericResource.setStats(liq);

      setStatsComp_genericFluid(liq);
    };
    exports.setStats = setStats_genericFluid;


    const update_genericFluid = function(liq, puddle) {
      updateComp_genericFluid(liq, puddle);
    };
    exports.update = update_genericFluid;
  // End
